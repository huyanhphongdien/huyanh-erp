...
export default function LoginPage() {
  ...
  return (
    ...
    >
      <Card
        style={{ width: 420, borderRadius: 16, boxShadow: '0 8px 32px rgba(0,0,0,0.3)' }}
      ...
      >
        ...
        {loadingOps ? (
          ...
          <Alert
            ...
            description="Liên hệ quản trị để tạo tài khoản trong bảng scale_operators."
            showIcon
          />
        ) : (
          <Space direction="vertical" size="middle" style={{ width: '100%' }}>
            <div>
              <Text strong style={{ display: 'block', marginBottom: 6 }}>Nhân viên cân</Text>
              <Select
            ...
            <div>
              <Text strong style={{ display: 'block', marginBottom: 6 }}>Mã PIN</Text>
              <Input.Password
                value={pin}
                onChange={(e) => {
