import{s as a}from"./index-DuaRnq-I.js";const f={diamond:"Kim cương",gold:"Vàng",silver:"Bạc",bronze:"Đồng",new:"Mới"},w={async getRooms(t={}){const e=t.page||1,r=t.pageSize||20,{search:n,filter:p,room_type:i}=t,c=(e-1)*r,m=c+r-1;let o=a.from("b2b_chat_rooms").select(`
        *,
