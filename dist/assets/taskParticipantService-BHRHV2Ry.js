import{s as i}from"./index-C3aWDepv.js";const k={async getParticipants(a){console.log("👥 [taskParticipantService] getParticipants for task:",a);try{const{data:t,error:r}=await i.from("task_assignments").select(`
          id,
          task_id,
          employee_id,
          role,
