import{s as i}from"./index-CfCyvpyB.js";const k={async getParticipants(a){console.log("👥 [taskParticipantService] getParticipants for task:",a);try{const{data:t,error:r}=await i.from("task_assignments").select(`
          id,
          task_id,
          employee_id,
          role,
