...
## ✅ ĐÃ XONG — trụ "TIỀN VÀO" + dòng tiền (Đợt 4→6)

### Đợt 4 — Phải thu khách hàng ✅ `/finance/receivables`
...
### Đợt 5 — Tồn quỹ 112 + Phải nộp định kỳ ✅ `/finance/cash`
...
### Đợt 6 — Dashboard dòng tiền tổng (AUDIT TOÀN BỘ) ✅ `/finance/cashflow`
- 1 màn hình BGĐ.
