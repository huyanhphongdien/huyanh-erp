...
**Email:** `minhld@huyanhrubber.com` (IT), `thuyht@huyanhrubber.com`, `huylv@huyanhrubber.com`

> `minhld` có quyền Admin trên hệ thống nhưng **không nhận email báo cáo hàng ngày**.
...
Gửi cho 3 người: **Giám đốc (huylv), Trợ lý BGĐ (thuyht), QL Sản xuất (trunglxh)**
...
A: 17:30 hàng ngày, gửi cho Giám đốc + Trợ lý BGĐ + QL Sản xuất (3 người).
