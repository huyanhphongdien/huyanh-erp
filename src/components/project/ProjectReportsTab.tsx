...
<div class="section">
  ...
  ${phases.length > 0 && project.planned_start && project.planned_end ? (function() {
    var mn = new Date(project.planned_start).getTime();
    var mx = new Date(project.planned_end).getTime();
