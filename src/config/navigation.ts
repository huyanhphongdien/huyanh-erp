// ============================================================
// NAVIGATION CONFIG - UPDATED: Thêm Chấm công tháng + Ẩn BÁO CÁO
// File: src/config/navigation.ts
// ============================================================
// CHANGES:
// - ★ Thêm "Chấm công tháng" (/attendance/monthly) — requireManager
// - ★ Ẩn group BÁO CÁO (đã có trong từng module riêng)
// ============================================================
...
export const navigationGroups: NavGroup[] = [
  ...
  // ★ CHẤM CÔNG — Thêm "Chấm công tháng"
  {
    title: 'CHẤM CÔNG',
    defaultOpen: true,
    items: [
      { label: 'Bảng chấm công', href: '/attendance', icon: Clock },
      { label: 'Chấm công tháng', href: '/attendance/monthly', icon: Calendar, requireManager: true },
