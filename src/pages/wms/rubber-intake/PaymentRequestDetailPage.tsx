...
function roundThousand(a?: number | null): number {
  return Math.round((a || 0) / 1000) * 1000
}
...
const PaymentRequestDetailPage: React.FC = () => {
  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      await exportPaymentRequestExcel(req, exportLines, { preparedBy: user?.full_name, msnv: user?.employee_code })
